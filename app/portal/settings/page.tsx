...
const EMPTY_DATA: MarketingAgencyCRMData = {
  ...
  banner: {
    status: "healthy",
    constraint: "Your client dashboard is ready.",
    recommendation: "Connect your CRM source to see live pipeline, activity, and revenue insights.",
...
function mapBoardToCrmData(board: BoardPayload | null, liveError: string): MarketingAgencyCRMData {
  if (!board) {
    ...
    return {
      ...
      banner: {
        status: "warning",
        constraint: "Live dashboard updates are unavailable.",
  ...
  return {
    ...
    banner: {
      ...
      constraint: toText(board.banner?.constraint, liveError ? "Live dashboard updates are unavailable." : EMPTY_DATA.banner.constraint),
