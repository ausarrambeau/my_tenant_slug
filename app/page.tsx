...
const EMPTY_DATA: MarketingAgencyCRMData = {
  ...
  banner: {
    status: "healthy",
    constraint: "Your dashboard is ready — connect your data to see live results.",
    recommendation: "Link your lead sources to start tracking your pipeline in real time.",
