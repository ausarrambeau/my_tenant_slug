...
const EMPTY_DATA: MarketingAgencyCRMData = {
  ...
  banner: {
    status: "healthy",
    constraint: "Your dashboard is ready once live CRM data is connected.",
    recommendation: "Link a lead source to see real-time pipeline activity and performance.",
